package com.josephbloxsom.check.Task_Stuff;
...
import com.josephbloxsom.check.R;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        mdueDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { //date picker
                ...
                if(!darkMode)
                {datePickerDialog = new DatePickerDialog(getActivity(), Create_Task_Dialog.this,  year, month, day);}
                else {datePickerDialog = new DatePickerDialog(getActivity(), AlertDialog.THEME_DEVICE_DEFAULT_DARK, Create_Task_Dialog.this, year, month, day);}
        ...
        mdueTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { // time picker
                ...
                if(!darkMode){
                timePickerDialog = new TimePickerDialog(getActivity(), Create_Task_Dialog.this, hour, minute, true);}
                else{timePickerDialog = new TimePickerDialog(getActivity(), AlertDialog.THEME_DEVICE_DEFAULT_DARK, Create_Task_Dialog.this, hour, minute, true);}
